...
object Resources {
  ...
  case class Classpath(classLoader: ClassLoader) extends Resources {
    ...
    /* Attempt to return the URL of a specific resource if it exists. */
    override def find(resource: String): IO[Option[URL]] = {
    ...
    override def list(directory: String): IO[Vector[String]] = {
